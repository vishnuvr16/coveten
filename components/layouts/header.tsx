...
const Header = () => {
    ...
    const headerColor = useSelector((state: IRootState) => state.themeConfig.headerColor);

    return (
        <header className={`z-40 ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}`}>
            <div className="shadow-sm">
                <div className={"relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black"} style={{ backgroundColor: headerColor}}>
                    <div className="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            <img className="inline w-8 ltr:-ml-1 rtl:-mr-1" src="/assets/images/logo.svg" alt="logo" />
                            <span className="hidden align-middle text-2xl  font-semibold  transition-all duration-300 ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light md:inline">COVETEN</span>
                        </Link>
                        <button
                            type="button"
                ...
                <ul className="horizontal-menu hidden border-t border-[#ebedf2] bg-white px-6 py-1.5 font-semibold text-black rtl:space-x-reverse dark:border-[#191e3a] dark:bg-black dark:text-white-dark lg:space-x-1.5 xl:space-x-8">
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1">{t('Communication')}</span>
                            </div>
                            <div className="right_arrow">
                                <IconCaretDown />
                            </div>
                        ...
                        <ul className="sub-menu">
                            <li>
                                <Link href="/apps/chat">{t('Internal Email')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/mailbox">{t('ongoing chats')}</Link>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1">{t('Services')}</span>
                            </div>
                            <div className="right_arrow">
                                <IconCaretDown />
                            </div>
                        ...
                        <li className="relative">
                            ...
                            <li>
                                <Link href="/apps/invoice">{t('Proforma Invoice')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/quotation">{t('Quotation')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/quotation-complaints">{t('Quotation Complaints')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/projects">{t('Porjects')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/all-tickets">{t('All tickets')}</Link>
                            </li>
                        </ul>
                    </li>
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1">{t('User Mangagement')}</span>
                            </div>
                            <div className="right_arrow">
                                <IconCaretDown />
                            </div>
                        ...
                        <ul className='sub-menu'>
                            <li>
                                <Link href="/apps/leads">{t('leads')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/users">{t('users')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/vendors">{t('vendors')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/roles">{t('roles')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/support">{t('support')}</Link>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                <IconMenuElements className="shrink-0" />
                                <span className="px-1">{t('Business')}</span>
                            </div>
                            <div className="right_arrow">
                                <IconCaretDown />
                            </div>
                        ...
                        <ul className='sub-menu'>
                            <li>
                                <Link href="/apps/add-product">{t('Add products')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/add-events">{t('Add events')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/add-benefits">{t('Add Benefits')}</Link>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                <IconMenuElements className="shrink-0" />
                                <span className="px-1">{t('Website')}</span>
                            </div>
                            <div className="right_arrow">
                                <IconCaretDown />
                            </div>
                        ...
                        <ul className='sub-menu'>
                            <li>
                                <Link href="/apps/homepage-video">{t('Homepage Video')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/homepage-capabilities">{t('Homepage Capabilities')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/homepage-services">{t('Homepage Services')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/homepage-service-network">{t('Homepage Service Network')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/homepage-whatwedo">{t('Homepage WhatWeDo')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/homepage-hero">{t('Homepage Hero')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/homepage-clients">{t('Homepage Clients')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/homepage-about-company">{t('About Company')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/productpage-hero">{t('Productpage Hero')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/productpage-adds">{t('Productpage Adds')}</Link>
                            </li>
                    ...
                    <li className="menu nav-item relative">
                        ...
                        <ul className='sub-menu'>
                        <li>
                                <Link href="/apps/categories">{t('Categories')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/services">{t('Services')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/solutions">{t('Solutions')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/features">{t('Features')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/learnitems">{t('Learn Items')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/aboutus">{t('About Us')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/legalpage">{t('LegalPage')}</Link>
                            </li>
                        </ul>
                    </li>
                </ul>
