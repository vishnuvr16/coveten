...
const IndustryPage: React.FC = () => {
  ...
  const [heroes, setHeroes] = useState<HeroDetails[]>([
    { id: 1, name: 'automotive', image: '/automotive.jpg' ,desc: ''},
    { id: 2, name: 'construction', image: '/construction.jpg', desc: '' },
    { id: 3, name: 'aerospace', image: '/aerospace.jpg' , desc: '' },
  ]);
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div>
              ...
              <input
                ...
                className="mt-1 block w-full border rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2"
              />
            </div>
            ...
            <div>
              ...
              <textarea value={newDesc} rows={5} onChange={(e)=> setNewDesc(e.target.value)} className="mt-1 block w-full border rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2">
