...
const themeConfigSlice = createSlice({
    ...
    reducers: {
        ...
        updateMenuColor(state, {payload}) {
            state.menuColor = payload;
            localStorage.setItem('menuColor', payload);
        },        
...
export const { toggleTheme, toggleMenu, toggleLayout, toggleRTL, toggleAnimation, toggleNavbar, toggleSemidark, toggleSidebar, resetToggleSidebar ,updatePrimaryColor , updateHeaderColor , updateMenuColor , updateBackgroundColor , resetColors } = themeConfigSlice.actions;
