...
import { Dialog, DialogPanel, Disclosure, DisclosureButton, DisclosurePanel, Menu, Transition, TransitionChild } from '@headlessui/react';
                                                    ...
                                                    {({ open }) => (
                                                        <>
                                                            <h3 className="-mx-2 -my-3 flow-root">
                                                                <DisclosureButton className="flex w-full items-center justify-between bg-white px-2 py-3 text-gray-400 hover:text-gray-500 cursor-pointer">
