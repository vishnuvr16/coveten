                    ...
                    <PerfectScrollbar className="relative h-[calc(100vh-80px)]">
                        <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                            ...
                            <li className="nav-item">
                                <ul>
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/mailbox" className="group">
                                            <div className="flex items-center">
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/chat" className="group">
                                            <div className="flex items-center">
                            ...
                            <li className="nav-item">
                                <ul>
                                    <li className="menu nav-item">
                                        ...
                                        <AnimateHeight duration={300} height={currentMenu === 'invoice' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <Link href="/admin/invoice/list">{t('list')}</Link>
                                                </li>
                                                <li>
                                                    <Link href="/admin/invoice/preview">{t('preview')}</Link>
                                                </li>
                                                <li>
                                                    <Link href="/admin/invoice/add">{t('add')}</Link>
                                                </li>
                                                <li>
                                                    <Link href="/admin/invoice/edit">{t('edit')}</Link>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/invoice/proforma" className="group">
                                            <div className="flex items-center">
                                                <IconMenuInvoice className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/quotation" className="group">
                                            <div className="flex items-center">
                                                <IconMenuChat className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/quotation/complaints" className="group">
                                            <div className="flex items-center">
                                                <IconMenuChat className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/tickets" className="group">
                                            <div className="flex items-center">
                            ...
                            <li className='nav-item'>
                                <ul>
                                     <li className="nav-item">
                                        <Link href="/admin/dashboard/leads" className="group">
                                            <div className="flex items-center">
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/vendors" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/roles" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/support" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                            ...
                            <li className='nav-item'>
                                <ul>
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/event" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/benefits" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                            ...
                            <li className='nav-item'>
                                <ul>
                                     <li className="nav-item">
                                        <Link href="/admin/dashboard/settings/homepage/video" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/settings/homepage/capabilities" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/settings/services" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/settings/homepage/services/network" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/settings/homepage/whatwedo" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/settings/homepage/hero" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/settings/homepage/clients" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/settings/homepage/aboutcompany" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/settings/productpage/hero" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/settings/productpage/ads" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/settings/categories" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/settings/solution" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/settings/industry" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/settings/features" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/settings/learnitems" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/settings/aboutus" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/dashboard/legalpage" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
