...
import IconCamera from '@/src/components/icon/icon-camera';
import IconCopy from '@/src/components/icon/icon-copy';
...
import IconLogin from '@/src/components/icon/icon-login';
import IconMenu from '@/src/components/icon/icon-menu';
import IconMessage from '@/src/components/icon/icon-message';
import IconMessagesDot from '@/src/components/icon/icon-messages-dot';
import IconMicrophoneOff from '@/src/components/icon/icon-microphone-off';
import IconMoodSmile from '@/src/components/icon/icon-mood-smile';
import IconPhone from '@/src/components/icon/icon-phone';
import IconPhoneCall from '@/src/components/icon/icon-phone-call';
...
import IconShare from '@/src/components/icon/icon-share';
