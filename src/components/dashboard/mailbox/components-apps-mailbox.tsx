...
import IconArchive from '@/src/components/icon/icon-archive';
import IconArrowBackward from '@/src/components/icon/icon-arrow-backward';
import IconArrowForward from '@/src/components/icon/icon-arrow-forward';
import IconArrowLeft from '@/src/components/icon/icon-arrow-left';
import IconBook from '@/src/components/icon/icon-book';
import IconBookmark from '@/src/components/icon/icon-bookmark';
import IconCaretDown from '@/src/components/icon/icon-caret-down';
import IconChartSquare from '@/src/components/icon/icon-chart-square';
import IconDownload from '@/src/components/icon/icon-download';
import IconFile from '@/src/components/icon/icon-file';
import IconFolder from '@/src/components/icon/icon-folder';
import IconGallery from '@/src/components/icon/icon-gallery';
import IconHelpCircle from '@/src/components/icon/icon-help-circle';
import IconHorizontalDots from '@/src/components/icon/icon-horizontal-dots';
import IconInfoHexagon from '@/src/components/icon/icon-info-hexagon';
import IconMail from '@/src/components/icon/icon-mail';
import IconMenu from '@/src/components/icon/icon-menu';
import IconMessage2 from '@/src/components/icon/icon-message2';
import IconOpenBook from '@/src/components/icon/icon-open-book';
import IconPaperclip from '@/src/components/icon/icon-paperclip';
import IconPlus from '@/src/components/icon/icon-plus';
import IconPrinter from '@/src/components/icon/icon-printer';
import IconRefresh from '@/src/components/icon/icon-refresh';
import IconRestore from '@/src/components/icon/icon-restore';
import IconSearch from '@/src/components/icon/icon-search';
import IconSend from '@/src/components/icon/icon-send';
import IconSettings from '@/src/components/icon/icon-settings';
import IconStar from '@/src/components/icon/icon-star';
import IconTag from '@/src/components/icon/icon-tag';
import IconTrash from '@/src/components/icon/icon-trash';
import IconTrashLines from '@/src/components/icon/icon-trash-lines';
import IconTxtFile from '@/src/components/icon/icon-txt-file';
import IconUser from '@/src/components/icon/icon-user';
import IconUserPlus from '@/src/components/icon/icon-user-plus';
import IconUsers from '@/src/components/icon/icon-users';
import IconVideo from '@/src/components/icon/icon-video';
import IconWheel from '@/src/components/icon/icon-wheel';
import IconZipFile from '@/src/components/icon/icon-zip-file';
